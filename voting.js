...
function getCandidateData(row) {
    ...
    if (nameElement) {
        ...
        if (candidateName.includes('എ.കെ നസീബ') || candidateName.includes('എ.കെ.നസീബ')) {
            name = 'എ.കെ നസീബ';
            englishName = 'Munniyoor';
            photo = 'assets/candid.jpeg';
            symbol = 'assets/ladder1.svg';
            ward = '10';
        } else if (candidateName.includes('അൻവർ സാദത്ത്') || candidateName.includes('അന്വർ സാദത്ത്')) {
            name = 'അൻവർ സാദത്ത്';
            englishName = 'Munniyoor';
            ...
            // Default handling for other candidates
            name = candidateName || 'Candidate';
            englishName = name.toUpperCase();
            
            // Generate a unique symbol based on candidate number and ballot type
            const symbolNumber = (parseInt(candidateNumber) % 3) + 1; // 1, 2, or 3
            symbol = `assets/ladder${symbolNumber}.svg`;
        }
    }
